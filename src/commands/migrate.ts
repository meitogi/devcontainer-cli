...
export function migrate(options: MigrateOptions): number {
	...
	say('                           and skills/sync-skills.sh — image lines before 1.3.0 still prefer a')
	say('                           workspace loader, which would install your skills alone and drop')
	say('                           the baked ones. To this CLI the tree is v3 from here on.')
